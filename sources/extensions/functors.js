;(function (global, factory) {
    ...
    **/
    api.forEachWith = function forEachWith (fn, list) {
        if (type.isNotFunction(fn)) {
            throw new Error('forEachWith expects fn to be function but saw ' + fn);
        }
        ...
        if (type.isNotArray(list)) {
            throw new Error('forEachWith expects list to be array but saw ' + list);
        }
    ...
    **/
    api.everyWith = function everyWith (fn, list) {
        if (type.isNotFunction(fn)) {
            throw new Error('everyWith expects fn to be function but saw ' + fn);
        }
        ...
        list = type.isSequencial(list) ?
               ...
               null;
        if (type.isNotArray(list)) {
            throw new Error('everyWith expects list to be array but saw ' + list);
        }
    ...
    **/
    api.someWith = function someWith (fn, list) {
        if (type.isNotFunction(fn)) {
            throw new Error('someWith expects fn to be function but saw ' + fn);
        }
        ...
        list = type.isSequencial(list) ?
               ...
               null;
        if (type.isNotArray(list)) {
            throw new Error('someWith expects list to be array but saw ' + list);
        }
