;(function (global, factory) {
    ...
    **/
    api.splitParse = function splitParse (fn, delimiter, str) {
        if (!type.isFunction(fn)) {
            throw 'splitParse expects fn to be function but saw ' + fn;
        }
        ...
        if (!type.isString(delimiter) && !type.isRegex(delimiter)) {
            throw 'splitParse expects delimiter to be string or regexp but saw ' + delimiter;
        }
        ...
        if (!type.isString(str)) {
            throw 'splitParse expects str to be string but saw ' + str;
        }
    ...
    **/
    api.substitude = function substitude (str, data) {
        ...
        if (!type.isString(str)) {
            throw 'substitude expects str to be string but saw ' + str;
        }
        ...
        if (!type.isObject(data)) {
            throw 'substitude expects data to be object but saw ' + data;
        }
